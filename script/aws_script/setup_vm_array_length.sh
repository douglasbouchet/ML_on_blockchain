...
# TODO: the workload is always the same, should be put inside generated folder
...
then
    echo "Error: generated/workload.yaml file not found. There should be one"
    exit 1
fi
...
# we can use any arguments, just need one
