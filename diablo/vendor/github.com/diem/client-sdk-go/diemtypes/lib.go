...
func BcsDeserializeAccountAuthenticator(input []byte) (AccountAuthenticator, error) {
	if input == nil {
		var obj AccountAuthenticator
		return obj, fmt.Errorf("Cannot deserialize null array")
	}
	deserializer := bcs.NewDeserializer(input);
	obj, err := DeserializeAccountAuthenticator(deserializer)
	if err == nil && deserializer.GetBufferOffset() < uint64(len(input)) {
		return obj, fmt.Errorf("Some input bytes were not read")
	}
	return obj, err
...
func DeserializeMetadata(deserializer serde.Deserializer) (Metadata, error) {
	...
	case 6:
		if val, err := load_Metadata__PaymentMetadata(deserializer); err == nil {
			return &val, nil
		} else {
			return nil, err
		}
...
func (*Metadata__PaymentMetadata) isMetadata() {}
...
func load_Metadata__PaymentMetadata(deserializer serde.Deserializer) (Metadata__PaymentMetadata, error) {
	var obj Metadata__PaymentMetadata
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializePaymentMetadata(deserializer); err == nil { obj.Value = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func DeserializePaymentMetadata(deserializer serde.Deserializer) (PaymentMetadata, error) {
	...
	switch index {
	case 0:
		if val, err := load_PaymentMetadata__PaymentMetadataVersion0(deserializer); err == nil {
			return &val, nil
		} else {
			return nil, err
		}
	...
	default:
		return nil, fmt.Errorf("Unknown variant index for PaymentMetadata: %d", index)
	}
}

func BcsDeserializePaymentMetadata(input []byte) (PaymentMetadata, error) {
	if input == nil {
		var obj PaymentMetadata
		return obj, fmt.Errorf("Cannot deserialize null array")
	}
	deserializer := bcs.NewDeserializer(input);
	obj, err := DeserializePaymentMetadata(deserializer)
	if err == nil && deserializer.GetBufferOffset() < uint64(len(input)) {
		return obj, fmt.Errorf("Some input bytes were not read")
	}
	return obj, err
...
func (*PaymentMetadata__PaymentMetadataVersion0) isPaymentMetadata() {}
...
func load_PaymentMetadata__PaymentMetadataVersion0(deserializer serde.Deserializer) (PaymentMetadata__PaymentMetadataVersion0, error) {
	var obj PaymentMetadata__PaymentMetadataVersion0
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializePaymentMetadataV0(deserializer); err == nil { obj.Value = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *PaymentMetadataV0) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	if err := serialize_array16_u8_array(obj.ReferenceId, serializer); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func DeserializePaymentMetadataV0(deserializer serde.Deserializer) (PaymentMetadataV0, error) {
	var obj PaymentMetadataV0
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := deserialize_array16_u8_array(deserializer); err == nil { obj.ReferenceId = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func BcsDeserializePaymentMetadataV0(input []byte) (PaymentMetadataV0, error) {
	...
	deserializer := bcs.NewDeserializer(input);
	obj, err := DeserializePaymentMetadataV0(deserializer)
	if err == nil && deserializer.GetBufferOffset() < uint64(len(input)) {
		return obj, fmt.Errorf("Some input bytes were not read")
	}
	return obj, err
...
func DeserializeRefundReason(deserializer serde.Deserializer) (RefundReason, error) {
	...
	case 4:
		if val, err := load_RefundReason__InvalidReferenceId(deserializer); err == nil {
			return &val, nil
		} else {
			return nil, err
		}
...
func (*RefundReason__InvalidReferenceId) isRefundReason() {}
...
func load_RefundReason__InvalidReferenceId(deserializer serde.Deserializer) (RefundReason__InvalidReferenceId, error) {
	var obj RefundReason__InvalidReferenceId
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *TransactionAuthenticator__MultiAgent) Serialize(serializer serde.Serializer) error {
	...
	serializer.SerializeVariantIndex(2)
	if err := obj.Sender.Serialize(serializer); err != nil { return err }
	if err := serialize_vector_AccountAddress(obj.SecondarySignerAddresses, serializer); err != nil { return err }
	if err := serialize_vector_AccountAuthenticator(obj.SecondarySigners, serializer); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func load_TransactionAuthenticator__MultiAgent(deserializer serde.Deserializer) (TransactionAuthenticator__MultiAgent, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializeAccountAuthenticator(deserializer); err == nil { obj.Sender = val } else { return obj, err }
	if val, err := deserialize_vector_AccountAddress(deserializer); err == nil { obj.SecondarySignerAddresses = val } else { return obj, err }
	if val, err := deserialize_vector_AccountAuthenticator(deserializer); err == nil { obj.SecondarySigners = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func deserialize_vector_AccountAuthenticator(deserializer serde.Deserializer) ([]AccountAuthenticator, error) {
	...
	for i := range(obj) {
		if val, err := DeserializeAccountAuthenticator(deserializer); err == nil { obj[i] = val } else { return nil, err }
	}
	return obj, nil
}
